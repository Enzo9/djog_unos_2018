#############################################################################
# Makefile for building: djog_unos_2018
# Generated by qmake (3.0) (Qt 5.7.1)
# Project:  djog_unos_2018.pro
# Template: app
# Command: /usr/lib/i386-linux-gnu/qt5/bin/qmake -o Makefile djog_unos_2018.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = djog_unos_20181.0.0
DISTDIR = /home/development/djog_unos/djog_unos_2018/.tmp/djog_unos_20181.0.0
SUBTARGETS    =  \
		release \
		debug
...
Makefile: djog_unos_2018.pro /usr/lib/i386-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/i386-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		...
		/usr/lib/i386-linux-gnu/qt5/mkspecs/features/exclusive_builds_post.prf \
	...
	$(QMAKE) -o Makefile djog_unos_2018.pro
